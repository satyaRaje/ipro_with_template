...
<div class="row">
	...
	<div class="col-md-5">
    	...
    	<img class="card-img-top img-responsive" id="myDiv" style="height: 250px;"  src="<?php echo base_url()."uploads/shop/".$d->pname.$d->rand."/".$d->front_View;?>" alt="Card image cap">
     </div><br>
     <div class="row">
     
      <div class="col-md-2 border-right  border-bottom border-left border-top" style="max-height: 150px"  id="col1" onclick="col1()">
      	<br>
             <img class="card-img-top img-responsive  border-bottom border-top" style="height: 100px;" src=<?php echo base_url()."uploads/shop/".$d->pname.$d->rand."/".$d->front_View;?> alt="Card image cap">
             <br>
      ...
      <div class="col-md-2 border-right  border-bottom border-top" style="max-height: 150px" id="col2" onclick="col2()">
      	<br>
         <img class="card-img-top img-responsive border-bottom" style="height: 100px;" src=<?php echo base_url()."uploads/shop/".$d->pname.$d->rand."/".$d->bottom_view;?> alt="Card image cap">
          <br>
      </div>
      <div class="col-md-2 border-right border-bottom border-top" style="max-height: 150px" id="col3" onclick="col3()">
      	<br>
          <img class="card-img-top img-responsive" style="height: 100px;" src=<?php echo base_url()."uploads/shop/".$d->pname.$d->rand."/".$d->left_view?> alt="Card image cap">
          <br>
      </div>
      <div class="col-md-2 border-right border-bottom border-top" style="max-height: 150px" id="col4" onclick="col4()">
      	<br>
          <img class="card-img-top img-responsive" style="height: 100px;" src=<?php echo base_url()."uploads/shop/".$d->pname.$d->rand."/".$d->right_view?> alt="Card image cap">
          <br>
      </div>
      <div class="col-md-2 border-right border-bottom border-top" style="max-height: 150px" id="col5" onclick="col5()">
      	<br>
          <img class="card-img-top img-responsive" style="height: 100px;" src=<?php echo base_url()."uploads/shop/".$d->pname.$d->rand."/".$d->isomatric_view;?> alt="Card image cap">
          <br>
      </div>
  </div>
	</div>
