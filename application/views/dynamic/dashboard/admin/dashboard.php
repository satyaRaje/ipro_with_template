<div class="page-wrapper">
    <div class="row" style="padding: 10px;">
        ...
        <div class="col-12">
            ...
            <div class="col-lg-4">
                <!-- Column -->
                <div class="card"> <img class="" src="<?php echo base_url();?>style/full/assets/images/background/profile-bg.jpg" alt="Card image cap">
                    <div class="card-body little-profile text-center">
                        <div class="pro-img"><img src="<?php echo base_url();?>style/full/assets/images/users/4.jpg" alt="user"></div>
