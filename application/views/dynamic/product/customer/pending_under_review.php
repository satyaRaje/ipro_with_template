                        ...
                        <div class="row">
                            ...
                            <?php if($d->flag==0){ ?>
                                ...
                                <form method="post"action='<?php echo base_url()."index.php/dynamic/product/ci_upload_product/generate_quotation";?>' >
                                    ...
                                    <a href="#"><button type="submit" class=" btn btn-rounded btn-danger" style="margin-left: 80px;"><i class="mdi mdi-briefcase-upload"></i>Generate Quotation </button></a>
                                                                    </form>
                                <button type="submit" class=" btn btn-rounded btn-primary btn-sm" style="margin-left: 80px;"> <i class="mdi mdi-briefcase-upload"></i>Generate Quotation</button></a>
                            <?php } ?>
                            <?php if($d->flag==100){ ?>
