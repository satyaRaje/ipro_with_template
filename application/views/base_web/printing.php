...
<div class="row" align="center">
    ...
    <br>
      <a href="<?php echo base_url();?>index.php/welcome/testimonial" class="list-group-item">
    ...
    <div class="col-md-8 col-xlg-6">
        <div class="card">
            <div class="card-body" style="background-color:#F5F5F5;">
              ...
              <br>
              <p class="text font-normal;" style="text-align: justify;" align="left"><font color="black">
