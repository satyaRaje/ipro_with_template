...
<div class="card-body" style="background-color:#F5F5F5;">
                    ...
                    <h2 class="card-title" id="design" align="center" style="font-weight: bold;font-family: Philosiphers"><font color="black">5. Design for 3D Printing</font></h2>
                                                    
                            <p class="text font-normal;" style="text-align: justify;"><font color="black">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Design for 3d printing is a designing process through which the part can be design according to its final use or purpose but can be optimized for easy 3d printing for reducing the chance of any errors or defects occurrence during the 3d printing process or after production of final part.<br></font></p>
<div class="row">
                  <div class="col-md-4">
          ...
          <p class="text font-normal;" style="text-align: justify;"></br><font color="black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Small batch production can be done using 3d printing technology for directly producing end use parts.SLS (Selective laser sintering), DMLS (Direct Metal Laser Sintering), SLA (Stereolithography), etc. machines are ideally suited to producing low volume plastic and metal parts, from one to as many as thousands.</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3D printing produces parts in engineering grade and biocompatible materials which provides both strong and accurate parts as well as affordable which makes it a perfect application for your batch production needs.</br></br><br></p><br><br></font></p>
                        </div>
           </div><br>
</div>
