                                ...
                                <h2 class="card-title" align="center"><font color="black">Mutation Student Registration Form</font></h2>                     <form class="form-material m-t-40">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" value=""> </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <select class="form-control">
                                            ...
                                            <option>Jawaharlal Nehru College of Engineering</option>
                                            <option>PES College of Engineering</option>
                                            <option>Other</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control">
                                            ...
                                            <option>Manifacturing Process</option>
                                            <option>Automobile</option>
                                            <option>Aerospace</option>
                                            <option>Medical/Health care</option>
                                            <option>Exploring new Technologies</option>
                                            <option>Website Design and App Development</option>
                                        </select>
                                    </div>
