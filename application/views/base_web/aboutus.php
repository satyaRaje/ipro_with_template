    ...
    <div class="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-9 col-xlg-10 col-md-8">
                    <div class="card">
                        <div class="card-body">
                           ...
                           <h6 style="font-weight: bold;"><i>Report abusive content:<br>
                                   If you think that this website presents abusive content, you may inform us at report@ipro3d.io</i></h6>
                        </div>
               ...
               <br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" id="2">History</h4>
                            <div class="row">
                                <div class="col-md-6">
                                  <h1>2016</h1>
                                    <ul>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" id="3">Our Approach</h4>
                          <p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" id="4">Our Team</h4>
                            ...
                            <div class="col-lg-3 col-xlg-3 col-md-5">
                                  <div class="card">
                                          <center class="m-t-30"> <img src='<?php echo base_url()."images/team/t1.jpg"?>' class="img-circle" width="150">
                                              <h4 class="card-title m-t-10">Er. Yogesh C. Pawar</h4>
                            ...
                            <div class="col-lg-3 col-xlg-3 col-md-5">
                                <div class="card">
                                    <center class="m-t-30"> <img src='<?php echo base_url()."images/team/t2.png"?>' class="img-circle" width="150">
                                        <h4 class="card-title m-t-10">Dr.Chandrakant T Pawar</h4>
                            ...
                            <div class="col-lg-3 col-xlg-3 col-md-5">
                                <div class="card">
                                    <center class="m-t-30"> <img src='<?php echo base_url()."images/team/t3.jpg"?>' class="img-circle" width="150">
                                        <h4 class="card-title m-t-10">Er. Vivek R Mugdal</h4>
                            ...
                            <div class="col-lg-3 col-xlg-3 col-md-5">
                                <div class="card">
                                    <center class="m-t-30"> <img src='<?php echo base_url()."images/team/t4.jpg"?>' class="img-circle" width="150">
                                        <h4 class="card-title m-t-10">Mr. Yash C. Pawar</h4>
                                        <h6 class="card-subtitle">Intern (Graphic design, Arts and animated modeling)</h6>
                            ...
                            <h3 style="font-weight: bolder">We have two teams working towards same goal</h3>
                             <ul>
                                 <li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" id="5">Company Ethics</h4>
                            <p>
...
<br>
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" id="6">Authentic</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" id="1">Careers</h4>
                            <h3 style="font-weight: bold;" >Job openings</h3>
                            ...
                            <p>The accuracy of the 3d printed part is reflected from its 3D design/model.</p>
                            <h6 style="font-weight: bold;">Authentic Appearance<br>
                                    </h6>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" id="7">Accuracy</h4>
                            <p>     You are in the era of technology which has changed the world in an innovative way. Now, it is possible to change the 2D designs into a 3d physical object/part with advanced technological equipment and software solutions. Accuracy, quality and lead time are the key points in 3d printing processes. We at IPRO3D use high end software solutions and equipment which assure greater accuracy and fine quality in the final 3d printed product.</p>
                            <h5>IPRO3D a socially responsible business:</h5>
                            <ol>
                                <li>The company runs with a strong focus on Corporate Social Responsibility.</li>
