                                ...
                                <form class="form p-t-20">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="email" class="form-control" id="exampleInputuname" required="" data-validation-required-message="This field is required" aria-invalid="true" placeholder="Username"> 
